...
\begin{itemize}
  \item \textbf{Availability} measures the proportion of time that a system is operational and able to fulfill its function (Sarja \& Halilov, 2023). For charging infrastructure, failed stations directly reduce customer access and revenue, making availability a primary performance indicator. Predictive maintenance can increase availability by 5--15\,\% according to McKinsey estimates, while reducing maintenance costs by 18--25\,\% (Sarja \& Halilov, 2023).
...
Section~3.1 has thus established \emph{what} needs to be optimized: cost, availability, and service responsiveness under uncertainty. The remaining two streams — stochastic vehicle routing (Section~3.2) and approximate dynamic programming (Section~3.3) — provide the methodological tools for implementing these objectives in a mobile, spatially distributed, and dynamically evolving service environment (de Jonge \& Scarf, 2020; Alaswad \& Xiang, 2017).
