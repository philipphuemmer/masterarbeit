...
Each simulation day begins at 8:00 a.m. with route initialization for two maintenance teams. The daily planning process first assigns starting zones and incorporates unresolved tasks from the previous day, after which a policy-specific initial route is constructed. During the working period, new disruptions may occur, the teams advance along their routes, and the current plan may be updated if the selected policy triggers a re-optimization step. The day ends with the calculation and logging of operational and downtime-related costs.
...
The simulation is based on a real data set of publicly available charging infrastructure in the city of Würzburg. After filtering for operational stations, the data set contains 397 charging stations, consisting of both normal charging stations and fast-charging stations. For each station, relevant attributes include its location, charging power, number of charging points, commissioning date, and inferred age.
