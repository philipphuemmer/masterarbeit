"""
Monte-Carlo-Simulation für die CFA-Policy (gelernte Wertfunktion).

Führt N Läufe durch (Seed 1 … N), speichert jeden Lauf als
logs/cfa/json/run_<N>.json und logs/cfa/log/run_<N>.log.
Am Ende wird eine aggregierte Analyse als logs/cfa/log/cfa_overview.log gespeichert.

Voraussetzung: theta muss trainiert sein:
    python scripts/train_cfa.py

Ausführen:
    .venv/bin/python3 scripts/monte_carlo/run_mc_cfa.py --runs 30
    .venv/bin/python3 scripts/monte_carlo/run_mc_cfa.py --runs 10 --max-days 50 --verbose
"""
