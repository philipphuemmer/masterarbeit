...
Ausführen:
    .venv/bin/python3 scripts/monte_carlo/run_mc_myopic_plus.py --runs 30
    .venv/bin/python3 scripts/monte_carlo/run_mc_myopic_plus.py --runs 10 --max-days 50 --verbose
"""
...
def main() -> None:
    ...
    parser.add_argument("--log-dir", type=str, default="logs/myopic_plus",
                        help="Basisordner für JSON- und Log-Ausgaben (Standard: logs/myopic_plus)")
    ...
    for seed in seeds:
        ...
        sim.write_json(result, str(out_path), label="MYOPIC PLUS SIMULATION", run_id=seed,
