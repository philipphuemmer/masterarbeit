...
def main() -> None:
    ...
    parser.add_argument("--log-dir", type=str, default="logs/myopic",
                        help="Basisordner für JSON- und Log-Ausgaben (Standard: logs/myopic)")
    ...
    for seed in seeds:
        ...
        sim.write_json(result, str(out_path), label="MYOPIC SIMULATION", run_id=seed,
