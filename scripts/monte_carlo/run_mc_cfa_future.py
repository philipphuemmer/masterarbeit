...
def main() -> None:
    ...
    parser.add_argument("--log-dir",    type=str, default="logs/cfa_future",
                        help="Basisordner für JSON- und Log-Ausgaben (Standard: logs/cfa_future)")
    ...
    for seed in seeds:
        ...
        sim.write_json(result, str(out_path), label="CFA-FUTURE SIMULATION", run_id=seed,
