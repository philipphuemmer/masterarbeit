"""
CFA-Future – identische Policy-Logik wie CFA, aber mit kontrastiv gelerntem θ.

θ approximiert direkt C̃(drop k) aus Suffix-Simulationen:
    C̃(drop k) ≈ θᵀ φ(k)
    Label: cost_drop_k - cost_serve_k  (diskontiert, H=30 Tage)

Alle Planungs- und Replan-Entscheidungen sind identisch zu CFAModel.
Einziger Unterschied: θ stammt aus train_cfa_future.py (kontrastives Training).
"""
